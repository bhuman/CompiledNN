...
namespace NeuralNetwork
{
  namespace CompiledNNImpl
  {
    ...
    private:
      ...
      void pool(X86Assembler& a, ActivationFunctionHandler& afHandler, const unsigned int paddingHorizontal, const unsigned int paddingVertical, const unsigned int inputWidth, const unsigned int channels) const;
      unsigned int poolRow(X86Assembler& a, ActivationFunctionHandler& afHandler, const unsigned int paddingLeft, const unsigned int paddingVertical, const unsigned int inputWidth, const unsigned int outputWidth, const unsigned int channels) const;
    };
  }
}
